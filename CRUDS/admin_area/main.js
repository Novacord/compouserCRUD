...
async function ValorEditElemento(id) {
    try {
        ...
        document.getElementById('area').value = data[0].id_area;
		document.getElementById('staff').value = data[0].id_staff;
		document.getElementById('position').value = data[0].id_position;
		document.getElementById('journey').value = data[0].id_journey;
